...
void my1GlutKeyboard(unsigned char Key, int x, int y)
{
  switch(Key)
  {
...
{
  my1GlutKeyboard( value, 0, 0 );
}

/***************************************** myGlutMouse() **********/

void my1GlutMouse(int button, int button_state, int x, int y )
{
...
void my1GlutReshape( int x, int y )
{
...
int gluimain(int argc, char* argv[])
{
  /****************************************/
  ...
  glutReshapeFunc( my1GlutReshape );
  glutKeyboardFunc( my1GlutKeyboard );
  glutMotionFunc( myGlutMotion );
  glutMouseFunc( my1GlutMouse );
  ...
  edittext = new GLUI_EditText( glui, "Text:", ctext, 3, control_cb );
