...
AllActuatorsConfigType actuatorConfig =  {
	{ (90.0/12.0), 				radians(-179.0f)	,radians(179.0f), 	160, 1200}, // Hip
	{ (80.0/12.0)*(48.0/14.0), 	radians(-89.0f)		,radians(89.0f), 	160, 1200}, // Upperarm
	{ (60.0/14.0)*(48.0/18.0), 	radians(-230.0f)	,radians(45.0f), 	160, 1200}, // Forearm
