...
CommDefType commDef[CommDefType::NumberOfCommands] {
	...
	{ CommDefType::ENABLE_CMD,		"ENABLE", 	200, 	cmdENABLE},
	{ CommDefType::DISABLE_CMD,		"DISABLE", 	200, 	cmdDISABLE },
	{ CommDefType::POWER_CMD,		"POWER", 	200, 	cmdPOWER },
	...
	{ CommDefType::SET_CMD,	        "SET", 		200, 	cmdSET},
	{ CommDefType::GET_CMD,	        "GET", 		200, 	cmdGET},
	{ CommDefType::MOVETO_CMD,	    "MOVETO", 	200, 	cmdMOVETO},
