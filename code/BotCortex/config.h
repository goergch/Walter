...
#define ENCODER_SAMPLE_RATE 5 				// every [ms] the motors get a new position ( encoders could work up to 500Hz, but then we have less time to control the steppers))
