...
void ActuatorConfig::setDefaults() {
	...
	memory.persMem.armConfig[WRIST].config.stepperArm.stepper.maxAcc= 5000.0;
	memory.persMem.armConfig[WRIST].config.stepperArm.stepper.maxSpeed= 200.0;
	...
	memory.persMem.armConfig[ELLBOW].config.stepperArm.stepper.maxAcc= 20000.0;
	memory.persMem.armConfig[ELLBOW].config.stepperArm.stepper.maxSpeed= 500.0;
	memory.persMem.armConfig[ELLBOW].config.stepperArm.stepper.kP= 0.20;
	...
	memory.persMem.armConfig[FOREARM].config.stepperArm.stepper.maxAcc= 1500.0;
	memory.persMem.armConfig[FOREARM].config.stepperArm.stepper.maxSpeed= 180.0;
	memory.persMem.armConfig[FOREARM].config.stepperArm.stepper.kP= 0.1;
	...
	memory.persMem.armConfig[UPPERARM].config.stepperArm.stepper.maxSpeed= 200.0;
	...
	memory.persMem.armConfig[HIP].config.stepperArm.stepper.maxAcc= 1500.0;
	memory.persMem.armConfig[HIP].config.stepperArm.stepper.maxSpeed= 60.0;
...
StepperSetupData stepperSetup[MAX_STEPPERS] {
	...
	{ HIP,      true,     16,	HIP_EN_PIN, 	HIP_DIR_PIN, 	 HIP_CLK_PIN, 		0.9,	2.8, BLACK, GREEN, RED, BLUE},
	{ UPPERARM, false,    16,	UPPERARM_EN_PIN,UPPERARM_DIR_PIN,UPPERARM_CLK_PIN, 	1.8,	3.5, BLACK, GREEN, RED, BLUE},
	{ FOREARM,  true,     16, 	FOREARM_EN_PIN,	FOREARM_DIR_PIN, FOREARM_CLK_PIN, 	1.8,	1.4, NON_COLOR, NON_COLOR, NON_COLOR, NON_COLOR},
	{ ELLBOW,   false,    4,	ELBOW_EN_PIN, 	ELBOW_DIR_PIN,	 ELBOW_CLK_PIN, 	1.8,	0.7, BLACK, GREEN, RED, BLUE},
	{ WRIST,    true,     16,	WRIST_EN_PIN,	WRIST_DIR_PIN,	 WRIST_CLK_PIN, 	1.8,	0.4, BLACK, GREEN, RED, BLUE}
};
