...
The bearing at the right side, that is marked with a red circle is very close to the inner diameter of the belt pulley.  This space is for the forearm to fix the bearing with a thin ring.
